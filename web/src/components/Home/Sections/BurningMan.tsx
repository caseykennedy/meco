...
// Hooks
import useServiceGroup from '../../../hooks/useServiceGroup'
...
const BurningMan: React.FC = () => {
  ...
  // const potableWaterTankRental = data.filter(
  //   service => service.node.serviceCategoryName === 'Potable Water Tank Rental'
  // )[0].node
  // const privateBulkPotableWaterStorage = data.filter(
  //   service =>
  //     service.node.serviceCategoryName === 'Private Bulk Potable Water Storage'
  // )[0].node
  // const rvWater = data.filter(
  //   service => service.node.serviceCategoryName === 'RV Potable Water'
  // )[0].node
  return (
    <>
      <Section border={true}>
      ...
      <Box>
        <Accordion title={potableWaterTankRental.serviceCategoryName}>
          <div className="content">
            <Flex flexWrap="wrap" justifyContent="space-between" mb={4}>
              {potableWaterTankRental.services.map((service, idx) => (
                <S.Highlight key={idx}>
                  <Text as="p">
                    ...
                    {/* <Text as="span" fontSize={1}>
                      <strong>includes</strong>: first fill, pump and 15ft
                      garden hose
                      <br />
                      <br />
                      <strong>dimensions</strong>: 5 feet in diameter, 4 feet
                      tall
                    </Text> */}
              ...
              <S.Highlight className="emphasized">
                <Text as="p">
            ...
            <Text as="p">
              ...
              needed. It will be your choice to top off or not. Please have cash
        ...
        <Accordion title={privateBulkPotableWaterStorage.serviceCategoryName}>
          <div className="content">
            <Flex flexWrap="wrap" justifyContent="space-between" mt={4}>
              ...
              {privateBulkPotableWaterStorage.services.map((service, idx) => (
                <S.Highlight key={idx}>
                  <Text as="p">
                    <Text as="span" className="rental__title">
                      {service.name}
        ...
        <Accordion title={rvWater.serviceCategoryName}>
          <div className="content">
            <Flex
            ...
            >
              ...
              {rvWater.services.map((service, idx) => (
                <S.Highlight key={idx}>
                  <Text as="p">
                    <Text as="span" className="rental__title">
                      {service.name}
            ...
            {/* <BlockContent blocks={rvWater._rawBody || []} /> */}
